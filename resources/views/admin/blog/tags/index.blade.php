                ...
                @foreach($tags as $tag)
                    <tr>
                        ...
                        <td class="align-middle">
                            <a class="btn btn-info" href="{{ route('admin.blog.tags.edit', ['tag' => $tag->slug]) }}">
                                <i class="fas fa-edit"></i>
                            </a>
                            <button data-destroy="{{ route('admin.blog.tags.destroy', ['tag' => $tag->slug]) }}" type="button" class="btn btn-danger btn-destroy">
