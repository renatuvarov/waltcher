(function (factory) {
    ...
    $.extend($.summernote.plugins, {
        ...
        'add-text-tags': function (context) {
            ...
            self.generateBtn = function(tag, tooltip, contents) {
                return ui.button({
                    contents: contents,
                    tooltip: tooltip + ' <' + tag + '>',
            ...
            var em = self.generateBtn('em', 'Em text', '<b style="font-size: 16px; font-weight:bolder;">&lt;em&gt;</b>');
            ...
            context.memo('button.add-text-tags', function () {
                return ui.buttonGroup([
                    ...
                    ui.dropdown([
                        ...
                        //     children: [mark, small, ins, del, em]
                        // })
                        ui.buttonGroup({
                            className: 'note-add-text-tags-other',
                            children: [em]
